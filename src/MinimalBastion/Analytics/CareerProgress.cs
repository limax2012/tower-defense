...
public static class CareerProgression
{
    ...
    public static CareerProgress Analyze(IEnumerable<RunHistoryEntry> entries)
    {
        ...
        var achievements = new[]
        {
            ...
            Tracked("Modes", "standard_circuit", "Standard Circuit", "Secure Standard on all four arenas.", SecuredMapsForDirective(secured, "standard"), 4),
            Tracked("Modes", "signal_circuit", "Signal Circuit", "Secure Signal Gauntlet on all four arenas.", SecuredMapsForDirective(secured, "close_quarters"), 4),
            Tracked("Modes", "core_circuit", "Core Circuit", "Secure Core Six on all four arenas.", SecuredMapsForDirective(secured, "core_six"), 4),
            Tracked("Modes", "entrenched_circuit", "Entrenched Circuit", "Secure Entrenched on all four arenas.", SecuredMapsForDirective(secured, "no_reserves"), 4),
            Tracked("Modes", "directive_master", "Mode Master", "Secure all four modes.", directivesSecured, 4),
            Tracked("Modes", "doctrine_grid", "Mode Grid", "Secure every arena and mode combination.", mapDirectivePairs, 16),
            Tracked("Modes", "bastion_circuit", "Bastion Circuit", "Secure all four arenas on Bastion.", bastionMapsSecured, 4),
            Tracked("Modes", "bastion_doctrine", "Bastion Modes", "Secure all four modes on Bastion.", RequiredDirectives.Count(directive => bastionSecured.Any(entry => entry.ChallengeId.Equals(directive, StringComparison.OrdinalIgnoreCase))), 4),
            ...
            Tracked("Apex", "mastery_directives", "Apex Modes", "Secure every mode with an Apex tower.", apexDirectives, 4),
            Tracked("Apex", "mastery_grid", "Apex Grid", "Secure every arena and mode combination with an Apex tower.", apexMapDirectivePairs, 16),
            ...
            Tracked("Apex", "bastion_mastery_matrix", "Bastion Apex Matrix", "Secure every arena and mode combination on Bastion with an Apex tower.", bastionApexMapDirectivePairs, 16),
            ...
            Tracked("Endurance", "endless_directives", "Endless Modes", "Reach wave 50 with every mode.", wave50Directives, 4),
            Tracked("Endurance", "endless_matrix", "Endless Matrix", "Reach wave 50 for every arena and mode combination.", wave50MapDirectivePairs, 16),

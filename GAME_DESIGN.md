...
Current replayability comes from four authored arenas/campaigns, four difficulty profiles, strategic tower pools, two final roles for every tower, targeting, manual or automatic Protocol timing, persistent run history, and deterministic agent/seeds. Seeded player challenges and constrained-roster modes remain future candidates.

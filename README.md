...
- From **Load Saves**, open **Run History**, then **Medals & Records** to browse personal records, 20 repeatable run medals, and 32 career achievements. Paged catalogs mark every goal as earned or locked and track campaign, arena, directive, tactical-system, co-op, Mastery, and deep-Endless milestones.

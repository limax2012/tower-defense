...
- From **Load Saves**, open **Run History**, then **Medals & Records** to summarize retained runs into per-run medals, personal records, and career achievements. It tracks flawless, compact, specialist, tower-only, Bastion, Mastery, and deep-Endless accomplishments alongside arena and directive completion.

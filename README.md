...
The title-screen arena summary surfaces the best locally recorded result for the currently selected arena, difficulty, and directive. A deep endless result is shown as `BEST ENDLESS n`; other profiles never leak into that comparison.

...
- Expanded Tower Library into a two-tab Tactical Library available from title and pause. The new Threats tab documents all five base archetypes, exact defenses/economy, recommended counters, Elite/Boss multipliers, the 50% boss phase, and the visual language for Slow, Expose, Armor Break, Burn, and Stun.

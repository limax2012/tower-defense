...
- Bastion now uses 112% enemy health, 102% speed, full base credits, and 18 lives. Its five-seed Standard matrix clears 73/240 (30.4%) instead of 33/240 (13.8%); eight purposeful policies can win, while Surge remains hardest at 8/60 (13.3%). Close Quarters and Core Six remain 27.1% and 15.4%; Fundamentals now receives a fixed +25% opening budget and clears 48/240 (20.0%), including 3/60 on Surge.
...
- No Reserves is now player-facing **Fundamentals** and disables Protocols as well as Plates/Forge, with a fixed 25% opening-credit cushion. Its five-seed Hard audit clears 115/240 (47.9%), still 10.4 points below Standard Hard. The tuned Bastion sweep clears 48/240 (20.0%) through six distinct policies, while a separate ten-seed Surge stress check clears 6/120 (5.0%) through Anti-Swarm, Adaptive, and Upgrade-Focused instead of the former one-policy 1/120 outlier.
...
- Rapid Array now converts every primary hit into a clearly drawn 60%-damage ricochet to the nearest second enemy within 72 units. It remains capped at two total targets, while Rail Pin keeps the stronger isolated, armored, and long-range role. A 384-run all-map Hard audit completed after the change; the four forced Needle paths all completed construction, and Rapid remained below Rail in general-purpose impact rather than displacing it.
